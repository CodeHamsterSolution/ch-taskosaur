      ...
      case EmailTemplate.PASSWORD_RESET_CONFIRMATION:
        ...
        <div class="container">
          <div class="content">
            ...
            <div class="button-container">
              <a href="${process.env.FRONTEND_URL || 'http://localhost:7777'}/login" class="button">Login to Your Account</a>
            </div>
      ...
      case EmailTemplate.INVITATION_ACCEPTED:
        ...
        <div class="container">
          <div class="content">
            ...
            <div class="button-container">
              <a href="${process.env.FRONTEND_URL || 'http://localhost:7777'}/projects/${data.projectId}" class="button">View Project</a>
            </div>
          </div>
          <div class="footer">
            <p>Taskosaur - Modern Project Management</p>
      ...
      case EmailTemplate.INVITATION_DECLINED:
        ...
        <div class="container">
          <div class="content">
            ...
            <div class="button-container">
              <a href="${process.env.FRONTEND_URL || 'http://localhost:7777'}/projects/${data.projectId}/team" class="button">Manage Team</a>
            </div>
          </div>
          <div class="footer">
            <p>Taskosaur - Modern Project Management</p>
      ...
      case EmailTemplate.INVITATION_EXPIRED:
        ...
        <div class="container">
          <div class="content">
            ...
            <div class="button-container">
              <a href="${process.env.FRONTEND_URL || 'http://localhost:7777'}/projects/${data.projectId}/invite?email=${data.inviteeEmail}" class="button">Send New Invitation</a>
            </div>
          </div>
          <div class="footer">
            <p>Taskosaur - Modern Project Management</p>
